# -*- coding: utf-8 -*-
#
# bioscons documentation build configuration file, created by
...
# let's ask git for the version info
...
latex_documents = [
  ('index', 'bioscons.tex', u'bioscons Documentation',
   u'Noah Hoffman', 'manual'),
]
...
man_pages = [
    ('index', 'bioscons', u'bioscons Documentation',
     [u'Noah Hoffman'], 1)
]
